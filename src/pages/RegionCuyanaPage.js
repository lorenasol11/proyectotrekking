import './../styles/RegionCuyanaPage.css'


const RegionCuyanaPage = (props) => {
    return (
        ...
        <div className="circuitoscuyo">

            <div className="circuitocuyo">
                <img src="img/cascadaelsaltocuyo.jpg" alt="Cascada del Salto Azul"/>
                <div className="info">
                    <h5>Cascada del Salto Azul</h5>
            ...
            <div className="circuitocuyo">
                <img src="img/cerroarenalescuyo.jpg" alt="Cerro Arenales"/>
                <div className="info">
                    <h5>Cerro Arenales</h5>
            ...
            <div className="circuitocuyo">
                <img src="img/valledelapiedracuyo.jpg" alt="Valle de la Piedra"/>
                <div className="info">
                    <h5>Valle de la Piedra</h5>
...
export default RegionCuyanaPage;